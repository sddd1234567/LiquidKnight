...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string Product_Pearl5 = "pearl_5";
    public static string Product_Pearl20 = "pearl_20";
    public static string Product_Pearl50 = "pearl_50";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(Product_Pearl5, ProductType.Consumable);
        builder.AddProduct(Product_Pearl20, ProductType.Consumable);
        builder.AddProduct(Product_Pearl50, ProductType.Consumable);
    ...
    {
        BuyProductID(Product_Pearl5);
    }

    public void Buy20Pearls()
    {
        BuyProductID(Product_Pearl20);
    }

    public void Buy50Pearls()
    {
        BuyProductID(Product_Pearl50);
    }
